    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            ...
            <div class="modal-footer">
                   <form  method="post" role="form" action="DthMain">
                     <div class="panel-body">                            
                            <div class="row">                            
                                ...
                                <div class="col-sm-4">
                                 ...
                                 <div class="col-sm-4">
                                     <div class="form-group">
                                    <div class="form-group">
                                            <label>LIST PACKAGE</label>
                                            <input class="form-control" name="packs" id="packs" placeholder="6,7,12,11">
                                    </div>
                                </div>
                                </div>
                            ...
                            <br>
                                <div class="col-sm-4">                                
                                <button type="submit" name="ingresar" value="Ingresar" class="btn btn-lg btn-success btn-block"/>Deshabilitar</button>  
                                </div>
                                <div class="col-sm-4">
            ...
            <h1>Cargar Batch</h1>            
             <div class="modal-footer">
                   <form  method="post" role="form" action="UploadDisabled" enctype="multipart/form-data">
